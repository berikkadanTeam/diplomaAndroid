...
public class PreorderTabsDishesAdapter extends RecyclerView.Adapter<PreorderTabsDishesAdapter.ViewHolder>{

    private Context context;
    private List<RestaurantDishes> list;
    private int dishTypeID;
    private List<Menu> chosenDishList = new ArrayList<>();
    PreorderTabsMainActivity activity;

    PreorderTabsDishesAdapter(PreorderTabsMainActivity context, List<RestaurantDishes> list, int dishTypeID){
    ...
    @NonNull
    @Override
    public PreorderTabsDishesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(activity).inflate(R.layout.order_tabs_dishes_item, viewGroup, false);

        return new PreorderTabsDishesAdapter.ViewHolder(v);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull PreorderTabsDishesAdapter.ViewHolder viewHolder, final int i) {
